...
<div class="container" style="padding: 60px 20px; max-width: 480px;">
  <h1 class="page-title">Crear compte</h1>
  ...
  <form method="POST" action="/api/register.php" class="auth-form">
    ...
    <div class="form-group">
      ...
      <input type="password" name="password" class="input" required autocomplete="new-password" minlength="6" />
    </div>
    
    <button type="submit" class="primary" style="width: 100%; margin-top: 20px;">Crear compte</button>
    
    <div style="text-align: center; margin-top: 20px;">
      <p style="color: var(--color-text-muted);">Ja tens compte? <a href="/login">Inicia sessió</a></p>
    </div>
    
    <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--color-border);">
      <p style="text-align: center; color: var(--color-text-muted); margin-bottom: 16px;">O registra't amb:</p>
